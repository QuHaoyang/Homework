...
public class Ch3Ex2Activity extends AppCompatActivity {
    ...
    private void resetTargetAnimation() {
        ...
        animator2.setDuration(Integer.valueOf(durationSelector.getText().toString()));
        animator2.setRepeatMode(ValueAnimator.REVERSE);
        animator3.setRepeatCount(ValueAnimator.INFINITE);
        animator3.setInterpolator(new LinearInterpolator());
        animator3.setDuration(Integer.valueOf(durationSelector.getText().toString()));
        ...
        animator4.setDuration(Integer.valueOf(durationSelector.getText().toString()));
